...
public class ClientFrame extends javax.swing.JFrame {
    ...
    public ClientFrame(JSONObject ob, String user, String ip) {
        initComponents();
        ...
        jPanel1.add(new MainPanel(ip,9939,this, ob, user));
    }
...
//        this.setVisible(false);
        //jPanel1.remove(jPanel2);
        //jPanel1.add(new MainPanel("192.168.16.108",9939,this));
    }//GEN-LAST:event_jButton1ActionPerformed

    /**
     * @param args the command line arguments
     */
    public static void load(JSONObject ob, String user, String ip) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ClientFrame(ob, user,ip).setVisible(true);
            }
        });
    }
