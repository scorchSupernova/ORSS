 ...
 * @author rahma
 */
public class PaymentHistoryFrame extends javax.swing.JFrame {
    ...
    public PaymentHistoryFrame() {
        try {
            ...
            int a=25,b=50,c=500,d=20;
            for(String val : myList){
                val += "}";
                JSONObject ob2 = new JSONObject(val);
                JLabel lbl= new JLabel(ob2.getString("timeDate"));
                JLabel lbl2 = new JLabel(ob2.getString("amm") +"BDT thas been added from" + ob2.getString("sName") + "s account");
            ...
            Logger.getLogger(PaymentHistoryFrame.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentHistoryFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentHistoryFrame().setVisible(true);
            }
        });
    }
